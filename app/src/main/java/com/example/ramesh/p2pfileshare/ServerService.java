...
public class ServerService extends IntentService {
            ...
            try {
                ...
                while (true && serviceEnabled) {
                    ...
                    final File f = new File(Environment.getExternalStorageDirectory() +
                            "/com.example.ramesh.p2pfileshare/wifip2pshared-" + System.currentTimeMillis()
                            + ".jpg");
                    ...
                    Log.d("WIFITAG", "server: copying files " + f.toString());
    ...
    /*
            ...
            */
                    ...
                    signalActivity("File Transfer Complete, saved as: wifip2pshared-millisecond.jpg");
